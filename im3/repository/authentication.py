...
class Authentication:
    def __init__(self, phone_number):
        ...
        self.api_service_instance = IMIOAuthHelper("Android", "82.5.1", token_id)
    ...
    def verify_otp(self, transid, code):
        return self.api_service_instance.send_request("api/v2/otp/validate/v1", {"transid": transid, "otp": code})
